...
const ShopDetails = () => {
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      if (!cartId) {
        alert("Vui lòng tải lại trang để khởi tạo giỏ hàng");
        return;
      }
      ...
      if (res.ok) {
        ...
        alert(errData.message || "Thêm vào giỏ hàng thất bại");
      }
    } catch (error) {
    ...
    <>
      ...
      <section className="overflow-hidden relative pb-20 pt-5 lg:pt-20 xl:pt-28">
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex flex-col lg:flex-row gap-7.5 xl:gap-17.5">
            ...
            {/* ... Phần Image giữ nguyên, vì ta đã map mảng imgs ở trên ... */}
                ...
                <div>
                  ...
                  {product.imgs?.previews?.[previewImg] && (
                    <Image
                      ...
                      width={400}
                      height={400}
                      style={{ objectFit: 'contain' }} // Thêm để ảnh không bị méo
                    />
                  )}
                </div>
              </div>
            ...
            <div className="max-w-[539px] w-full">
              ...
              {/* Phần mô tả lấy từ DB */}
              <p className="text-gray-5 text-sm mb-4 line-clamp-2">{product.description}</p>

              <div className="flex flex-wrap items-center gap-5.5 mb-4.5">
                <div className="flex items-center gap-2.5">
                  {/* Stars */}
                  <div className="flex items-center gap-1 text-[#FFA645]">{/*...SVG Stars giữ nguyên...*/}</div>
              ...
              {/* Giữ nguyên UI Lists, Tabs, Options, Quantity... */}
              {/* ... */}
              
              {/* NÚT MUA HÀNG & THÊM VÀO GIỎ */}
              <div className="flex flex-wrap items-center gap-4.5 mt-7.5"> {/* Thêm mt-7.5 cho cách đều */}
                <div className="flex items-center rounded-md border border-gray-3">
                  {/* Nút +/- Quantity giữ nguyên */}
                </div>

                {/* NÚT Purchase Now -> Gọi hàm handleAddToCart */}
                <button
      ...
      <section className="overflow-hidden bg-gray-2 py-20">
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          ...
          {/* Tab 1: Description -> Hiển thị mô tả từ Backend */}
          ...
          {/* Tab 2 & 3 giữ nguyên của template... */}
