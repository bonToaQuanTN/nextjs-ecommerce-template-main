    ...
    <div className="group">
      <div className="relative overflow-hidden rounded-lg bg-[#F6F7FB] min-h-[403px]">
        <div className="text-center px-4 py-7.5">
          ...
          {/* 
            1. SỬA LINK: Trỏ đến trang chi tiết sản phẩm đi kèm ID thật từ Backend 
          */}
          ...
          {/* 
            2. SỬA LOGIC GIÁ: Chỉ hiện giá gốc nếu không có giá giảm. Thêm .toFixed(2)
          */}
          {item.discountedPrice ? (
            ...
            <span className="flex items-center justify-center font-medium text-lg text-dark">
